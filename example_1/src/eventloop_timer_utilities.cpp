                          ...
                          const struct timespec *repeat)
{
    ...
    struct itimerspec newValue = {.it_interval = repeat ? *repeat : nullTimeSpec,
                                  .it_value = initial ? *initial : nullTimeSpec
                                  };
                                             ...
                                             const struct timespec *period)
{
    ...
    EventLoopTimer *timer = reinterpret_cast<EventLoopTimer*>( malloc(sizeof(EventLoopTimer)) );
    if (timer == NULL) {
        return NULL;
    }
